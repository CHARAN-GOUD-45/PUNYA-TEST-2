...
export const Route = createFileRoute("/home-living")({
  head: () => ({
    meta: [
      { title: "Home & Living — Punya Ventures" },
      { name: "description", content: "Premium home and living gifts for wellness and comfort." },
    ],
  }),
...
function HomeLivingPage() {
  ...
  const filtered = useMemo(() => {
    let r = products.filter((p) => p.category === "Wellness & Lifestyle" || p.name.toLowerCase().includes("home"));
    ...
    <div>
      <section className="bg-gradient-luxury border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <h1 className="mt-3 font-display text-4xl lg:text-6xl text-primary">Home & Living</h1>
          <div className="gold-divider mt-4" />
          <p className="mt-5 text-muted-foreground max-w-2xl">Curated home and living essentials for comfort and elegance.</p>
        </div>
      </section>
